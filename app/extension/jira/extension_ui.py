...
wait.until(ExpectedCond.text_to_be_present_in_element((By.CSS_SELECTOR, '#projects > div > table > tbody > tr > td.cell-type-name > a'), 'SeleniumTest'))
...
wait.until(ExpectedCond.text_to_be_present_in_element((By.ID, 'customfield_11133-val'), '97'))          
